...
struct_df = pd.read_csv('data/fourm/structure.csv')[['class','name','alias']]
...
if choice == '技術相關':
    ...
    df_dtm = getData("data/fourm/mach_dtm_with_ner.csv")
    ...
    df_dtm = getData("data/fourm/mark_dtm_with_ner.csv")
