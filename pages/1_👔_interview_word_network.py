...
# 設定公司
company_df = pd.read_csv('data/dtm_corre_cooc/interview/interview_word_dict_dtm_TWM.csv')
...
if (company_option == "全部"):
    if (option=='correlatoin'):
        df_interact = pd.read_csv('data/pyvis_data/interview/correlation/all_correlation.csv')
    else:
        df_interact = pd.read_csv('data/pyvis_data/interview/coocurrence/all_coocurrence.csv')
else:
    if (option=='correlatoin'):
        df_interact = pd.read_csv(f'data/pyvis_data/interview/correlation/{company_option}_correlation.csv')
    else:
        df_interact = pd.read_csv(f'data/pyvis_data/interview/coocurrence/{company_option}_coocurrence.csv')
